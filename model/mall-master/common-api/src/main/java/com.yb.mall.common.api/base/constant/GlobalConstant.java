/*
 * Copyright (c) 2018. yb.net All Rights Reserved.
 * 项目名称：yb快速搭建企业级分布式微服务平台
 * 类名称：GlobalConstant.java
 * 创建人：刘兆明
 * 联系方式：yb.net@gmail.com
 * 开源地址: https://github.com/yb
 * 博客地址: http://blog.yb.net
 * 项目官网: http://yb.net
 */
package com.yb.mall.common.api.base.constant;
...
public class GlobalConstant {
	...
	public static final String ROOT_PREFIX = "yb";

	public static final int EXCEPTION_CAUSE_MAX_LENGTH = 2048;
	public static final int EXCEPTION_MESSAGE_MAX_LENGTH = 2048;

	public static final String ZK_REGISTRY_SERVICE_ROOT_PATH = "/yb/registry/service";
	public static final String ZK_REGISTRY_ID_ROOT_PATH = "/yb/registry/id";
	public static final String ZK_REGISTRY_PRODUCER_ROOT_PATH = "/yb/registry/producer";
	public static final String ZK_REGISTRY_CONSUMER_ROOT_PATH = "/yb/registry/consumer";
	public static final String ZK_REGISTRY_SEQ = "/yb/seq";
	...
	public static final class Sys {
		 ...
		 */
		public static final String DEFAULT_FILE_PATH = "yb/file/";
