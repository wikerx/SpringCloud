...
package com.yb.mall.common.api.core.aspect;



import com.yb.mall.common.api.base.dto.LoginAuthDto;
import com.yb.mall.common.api.base.dto.OperationLogDto;
import com.yb.mall.common.api.core.annotation.LogAnnotation;
import com.yb.mall.common.api.utils.JsonUtil;
import com.yb.mall.common.api.utils.PubUtils;
import com.yb.mall.common.api.utils.RequestUtil;
import com.yb.mall.common.api.utils.wrapper.Wrapper;
...
public class LogAspect {
	 ...
	 * Log annotation.
	 */
	//@Pointcut("@annotation(com.yb.mall.common.api.core.annotation.LogAnnotation)")
	...
	private void setRequestData(OperationLogDto uacLog, JoinPoint joinPoint) {
		...
		try {
			...
			String requestData = JsonUtil.toJson(parameter);
