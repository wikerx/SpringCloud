 ...
 * 卖家版 - 指定店铺的商品分类列表
 */
@Service("productListForStoreServiceProtocol")
public class ProductListForStoreServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(ProductListForStoreServiceProtocol.class);
    private final static String interfaceDesc = "卖家版 - 指定店铺的商品分类列表";
