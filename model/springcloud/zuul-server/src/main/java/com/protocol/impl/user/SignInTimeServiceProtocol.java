 ...
 * @Description:签到日历接口
 */
@Service("signInTimeServiceProtocol")
public class SignInTimeServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInTimeServiceProtocol.class);
    private final static String interfaceDesc = "签到日历接口";
    /**
     * @description:
     * @param code 签到日历接口编码
     * @param inputMap  请求参数
