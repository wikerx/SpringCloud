...
@Service("oddListServiceProtocol")
public class OddListServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(OddListServiceProtocol.class);
    private final static String interfaceDesc = "亚盘筛选列表";
