...
@Service("shareNewsServiceProtocol")
public class ShareNewsServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(ShareNewsServiceProtocol.class);
    private final static String interfaceDesc = "文章分享";
