 ...
 * 生活圈  发布图片
 */
@Service("lifeworldImgServiceProtocol")
public class lifeworldImgServiceProtocol implements ProtocolUtilService {
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            logger.info("{} 发布图片接口业务逻辑处理结果：{}",interfaceDesc,outMap.get("msg"));
        }
