 ...
 * @Description:
 */
@Service("collectJobServiceProtocol")
public class collectJobServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(collectJobServiceProtocol.class);
    private final static String interfaceDesc = "收藏或取消收藏职位";
