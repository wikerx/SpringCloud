 ...
 * 批量/单个 删除购物车商品
 */
@Service("cartDelBatchServiceProtocol")
public class CartDelBatchServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(CartDelBatchServiceProtocol.class);
    private final static String interfaceDesc = "批量/单个 删除购物车商品";
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            //商品IDs
            String productIds = String.valueOf(inputMap.get("productIds"));
            if (VerifyUtils.isEmpty(code, outMap, productIds, "productIds", logger, interfaceDesc))
                return outMap;
