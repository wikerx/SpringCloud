...
@Service("getSquadServiceProtocol")
public class GetSquadServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(GetSquadServiceProtocol.class);
    private final static String interfaceDesc = "获取比赛阵容";
