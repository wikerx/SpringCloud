 ...
 * weeklylist任务删除
 */
@Service("weeklylistdeleteServiceProtocol")
public class weeklylistdeleteServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "weeklylist任务删除";
