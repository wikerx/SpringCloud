 ...
 * 获取等级权限
 */
@Service("findPermissionServiceProtocol")
public class FindPermissionServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(FindPermissionServiceProtocol.class);
    private final static String interfaceDesc = "获取等级权限";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
