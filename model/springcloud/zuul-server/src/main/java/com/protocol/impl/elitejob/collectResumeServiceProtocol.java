 ...
 * @Description:
 */
@Service("collectResumeServiceProtocol")
public class collectResumeServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(collectResumeServiceProtocol.class);
    private final static String interfaceDesc = "收藏简历";
