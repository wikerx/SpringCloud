 ...
 * 查询用户所有地址
 */
@Service("finUserAddressServiceProtocol")
public class FinUserAddressServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(FinUserAddressServiceProtocol.class);
    private final static String interfaceDesc = "查询用户所有地址";
