 ...
 * 收到的回复
 */
@Service("repliedServiceProtocol")
public class RepliedServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(RepliedServiceProtocol.class);
    private final static String interfaceDesc = "收到的回复";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
