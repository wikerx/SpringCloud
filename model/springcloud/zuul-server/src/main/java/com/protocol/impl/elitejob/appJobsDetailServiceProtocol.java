 ...
 * @Description:
 */
@Service("appJobsDetailServiceProtocol")
public class appJobsDetailServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(appJobsDetailServiceProtocol.class);
    private final static String interfaceDesc = "职位_投递简历详情";
