package com.protocol.impl.weeklylist;
 ...
 * 周周清单今日有无任务
 */
@Service("weeklylistHasOrnotServiceProtocol")
public class weeklylistHasOrnotServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "周周清单今日有无任务";
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            String planTime = String.valueOf(inputMap.get("planTime"));
            if (VerifyUtils.isEmpty(code, outMap, planTime,"planTime",logger,interfaceDesc))
                return outMap;
