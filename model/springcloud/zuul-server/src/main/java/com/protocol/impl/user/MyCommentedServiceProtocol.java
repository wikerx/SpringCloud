 ...
 * 我的评论
 */
@Service("myCommentedServiceProtocol")
public class MyCommentedServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(MyCommentedServiceProtocol.class);
