 ...
 * 师傅端的我的发单列表
 */
@Service("selectMyBillingServiceProtocol")
public class SelectMyBillingServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "师傅端的我的发单列表";
