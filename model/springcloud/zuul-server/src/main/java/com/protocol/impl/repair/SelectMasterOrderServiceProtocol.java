 ...
 * 师傅端的我要接单
 */
@Service("selectMasterOrderServiceProtocol")
public class SelectMasterOrderServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "师傅端的我要接单";
