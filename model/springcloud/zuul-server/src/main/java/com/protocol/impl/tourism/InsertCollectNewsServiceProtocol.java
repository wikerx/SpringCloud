...
*/
@Service("insertCollectNewsServiceProtocol")
public class InsertCollectNewsServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(InsertCollectNewsServiceProtocol.class);
