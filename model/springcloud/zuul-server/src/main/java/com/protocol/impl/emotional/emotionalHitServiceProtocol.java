 ...
 * 话题点赞，取消点赞
 */
@Service("emotionalHitServiceProtocol")
public class emotionalHitServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "话题点赞，取消点赞";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            logger.info("{} 话题点赞，取消点赞逻辑处理结果：{}",interfaceDesc,outMap.get("msg"));
        }
