 ...
 * weeklylist修改任务
 */
@Service("weeklylistUpdatePlanServiceProtocol")
public class weeklylistUpdatePlanServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "weeklylist修改任务";
