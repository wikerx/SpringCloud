 ...
 *删除收藏的题
 */
@Service("deleteQuestionCollectServiceProtocol")
public class DeleteQuestionCollectServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "删除收藏的题";
