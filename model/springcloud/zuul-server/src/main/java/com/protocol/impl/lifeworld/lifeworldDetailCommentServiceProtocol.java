 ...
 * 生活圈（朋友圈详情评论）
 */
@Service("lifeworldDetailCommentServiceProtocol")
public class lifeworldDetailCommentServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "生活圈（朋友圈详情评论）";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            logger.info("{} 生活圈（朋友圈详情）逻辑处理结果：{}",interfaceDesc,outMap.get("msg"));
        }
