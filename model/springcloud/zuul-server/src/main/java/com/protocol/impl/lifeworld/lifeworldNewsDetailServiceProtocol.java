 ...
 * 文章详情
 */
@Service("lifeworldNewsDetailServiceProtocol")
public class lifeworldNewsDetailServiceProtocol implements ProtocolUtilService {
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            logger.info("{} 文章详情逻辑处理结果：{}",interfaceDesc,outMap.get("msg"));
        }
