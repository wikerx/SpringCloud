 ...
 *专项练习
 */
@Service("specialPracticeServiceProtocol")
public class SpecialPracticeServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "专项练习";
