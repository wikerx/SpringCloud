 ...
 * aftersale今日任务list
 */
@Service("aftersaleNowlistServiceProtocol")
public class aftersaleNowlistServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "aftersale今日任务list";
