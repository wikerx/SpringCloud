 ...
 * @Description:
 */
@Service("collectJCompServiceProtocol")
public class collectJCompServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(collectJCompServiceProtocol.class);
    private final static String interfaceDesc = "收藏或取消收藏公司";
