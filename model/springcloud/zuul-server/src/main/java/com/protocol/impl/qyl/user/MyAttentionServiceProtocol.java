 ...
 * 查询关注列表
 */
@Service("myAttentionServiceProtocol")
public class MyAttentionServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(MyAttentionServiceProtocol.class);
    private final static String interfaceDesc = "查询关注列表";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
