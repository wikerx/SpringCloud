 ...
 * 生活圈（我的收藏）
 */
@Service("lifeworldMyCollectServiceProtocol")
public class lifeworldMyCollectServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "生活圈（我的收藏）";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            logger.info("{} 生活圈（我的收藏）逻辑处理结果：{}",interfaceDesc,outMap.get("msg"));
        }
