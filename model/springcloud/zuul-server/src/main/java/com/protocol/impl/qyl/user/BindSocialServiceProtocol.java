 ...
 * 绑定（取消绑定）社交账号（完善信息）
 */
@Service("bindSocialServiceProtocol")
public class BindSocialServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(BindSocialServiceProtocol.class);
    private final static String interfaceDesc = "绑定（取消绑定）社交账号（完善信息）";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
