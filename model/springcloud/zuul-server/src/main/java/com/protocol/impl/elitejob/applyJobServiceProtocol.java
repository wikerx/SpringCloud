 ...
 * @Description:
 */
@Service("applyJobServiceProtocol")
public class applyJobServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(applyJobServiceProtocol.class);
    private final static String interfaceDesc = "申请职位";
