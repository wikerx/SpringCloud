 ...
 * 师傅端的我要接单详情
 */
@Service("selectOrderParticularsServiceProtocol")
public class SelectOrderParticularsServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "师傅端的我要接单详情";
