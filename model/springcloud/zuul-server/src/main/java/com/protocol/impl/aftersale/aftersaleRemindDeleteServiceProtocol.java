 ...
 * aftersale删除提醒事项
 */
@Service("aftersaleRemindDeleteServiceProtocol")
public class aftersaleRemindDeleteServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "aftersale删除提醒事项";
