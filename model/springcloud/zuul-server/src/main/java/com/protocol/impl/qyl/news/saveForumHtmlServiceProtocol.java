 ...
 * @Description:
 */
@Service("saveForumHtmlServiceProtocol")
public class saveForumHtmlServiceProtocol  implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(saveForumHtmlServiceProtocol.class);
