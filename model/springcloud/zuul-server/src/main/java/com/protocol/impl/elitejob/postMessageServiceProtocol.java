 ...
 * @Description:
 */
@Service("postMessageServiceProtocol")
public class postMessageServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(postMessageServiceProtocol.class);
    private final static String interfaceDesc = "发送消息";
