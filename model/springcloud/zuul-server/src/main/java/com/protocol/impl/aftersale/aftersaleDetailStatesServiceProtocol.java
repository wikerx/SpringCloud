 ...
 * aftersale任务详情修改状态
 */
@Service("aftersaleDetailStatesServiceProtocol")
public class aftersaleDetailStatesServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "aftersale任务详情修改状态";
