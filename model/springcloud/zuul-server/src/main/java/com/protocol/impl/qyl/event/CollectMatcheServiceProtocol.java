...
@Service("collectMatcheServiceProtocol")
public class CollectMatcheServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(CollectMatcheServiceProtocol.class);
    private final static String interfaceDesc = "收藏球赛";
