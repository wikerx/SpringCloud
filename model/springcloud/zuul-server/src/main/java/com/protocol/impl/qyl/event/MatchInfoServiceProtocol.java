...
@Service("matchInfoServiceProtocol")
public class MatchInfoServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(MatchInfoServiceProtocol.class);
    private final static String interfaceDesc = "比赛共通信息";
