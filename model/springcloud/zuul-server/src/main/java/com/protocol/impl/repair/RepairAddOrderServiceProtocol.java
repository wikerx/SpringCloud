 ...
 * 维修查询
 */
@Service("repairAddOrderServiceProtocol")
public class RepairAddOrderServiceProtocol implements ProtocolUtilService {
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            String addressId = String.valueOf(inputMap.get("addressId"));
            if (VerifyUtils.isEmpty(code, outMap, addressId, "addressId", logger, interfaceDesc))
                return outMap;
            ...
            // String appointmentTime = String.valueOf(inputMap.get("appointmentTime"));
            // if (VerifyUtils.isEmpty(code, outMap, appointmentTime, "appointmentTime", logger, interfaceDesc))
            //     return outMap;

            String repairTypeId = String.valueOf(inputMap.get("repairTypeId"));
            if (VerifyUtils.isEmpty(code, outMap, repairTypeId, "repairTypeId", logger, interfaceDesc))
                return outMap;
