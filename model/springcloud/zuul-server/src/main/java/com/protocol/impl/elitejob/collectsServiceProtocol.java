 ...
 * @Description:
 */
@Service("collectsServiceProtocol")
public class collectsServiceProtocol  implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(findNewsDetailServiceProtocol.class);
    private final static String interfaceDesc = "我的收藏";
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            if (VerifyUtils.getTokenByUserId(code, inputMap, outMap, userId,logger,interfaceDesc))
                return outMap;
            String optId = String.valueOf(inputMap.get("optId"));
            if (VerifyUtils.isEmpty(code, outMap, optId,"optId",logger,interfaceDesc))
                return outMap;
