 ...
 * 小习惯，添加心情
 */
@Service("habitInsMoodServiceProtocol")
public class habitInsMoodServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "小习惯，添加心情";
