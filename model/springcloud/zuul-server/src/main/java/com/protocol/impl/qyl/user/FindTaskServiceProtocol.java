 ...
 * 任务积分接口
 */
@Service("findTaskServiceProtocol")
public class FindTaskServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(FindTaskServiceProtocol.class);
    private final static String interfaceDesc = "任务积分接口";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
