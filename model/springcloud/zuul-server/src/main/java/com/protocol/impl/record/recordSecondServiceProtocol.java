 ...
 * 记账App统计二级页面
 */
@Service("recordSecondServiceProtocol")
public class recordSecondServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "记账App统计二级页面";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
