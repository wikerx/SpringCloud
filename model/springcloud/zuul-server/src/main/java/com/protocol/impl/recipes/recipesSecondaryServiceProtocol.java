 ...
 * 首页二级菜谱接口
 */
@Service("recipesSecondaryServiceProtocol")
public class recipesSecondaryServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "菜谱首页二级菜谱接口";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
