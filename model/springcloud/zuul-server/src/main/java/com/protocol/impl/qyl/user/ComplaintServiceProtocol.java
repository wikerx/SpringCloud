 ...
 * 用户举报
 */
@Service("complaintServiceProtocol")
public class ComplaintServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(ComplaintServiceProtocol.class);
    private final static String interfaceDesc = "用户举报";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
