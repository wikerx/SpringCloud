 ...
 * 吃喝玩乐详情图片list
 */
@Service("imgDetailListServiceProtocol")
public class imgDetailListServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "吃喝玩乐详情图片list";
