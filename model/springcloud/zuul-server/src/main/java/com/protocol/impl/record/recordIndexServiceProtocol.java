 ...
 * 记账App统计首页
 */
@Service("recordIndexServiceProtocol")
public class recordIndexServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "记账App统计首页";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
