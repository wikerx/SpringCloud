 ...
 * 提交订单接口
 */
@Service("submitOrderServiceProtocol")
public class SubmitOrderServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SubmitOrderServiceProtocol.class);
    private final static String interfaceDesc = "提交订单接口";
