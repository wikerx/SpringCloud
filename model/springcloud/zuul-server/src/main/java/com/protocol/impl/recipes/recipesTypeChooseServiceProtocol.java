 ...
 * 菜谱分类接口
 */
@Service("recipesTypeChooseServiceProtocol")
public class recipesTypeChooseServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "菜谱分类接口";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
