 ...
 * 卖家版 - 文章点赞、取消点赞
 */
@Service("freshNewsHitOrCancelServiceProtocol")
public class FreshNewsHitOrCancelServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(FreshNewsHitOrCancelServiceProtocol.class);
    private final static String interfaceDesc = "文章点赞、取消点赞";
