 ...
 * 查询用户所有订单
 */
@Service("selectMyOrderServiceProtocol")
public class SelectMyOrderServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SelectMyOrderServiceProtocol.class);
    private final static String interfaceDesc = "查询用户所有订单";
