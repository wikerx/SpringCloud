 ...
 * 积分录入系统详情页
 */
@Service("scoreDetailServiceProtocol")
public class scoreDetailServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "积分录入系统详情页";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            logger.info("{} 积分录入系统详情页接口业务逻辑处理结果：{}",interfaceDesc,outMap.get("msg"));
        }
