 ...
 * 装修app（公司主页图集）
 */
@Service("renovationComImgsServiceProtocol")
public class renovationComImgsServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "装修app（公司主页图集）";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            logger.info("{} 装修app（公司主页图集）接口业务逻辑处理结果：{}",interfaceDesc,outMap.get("msg"));
        }
