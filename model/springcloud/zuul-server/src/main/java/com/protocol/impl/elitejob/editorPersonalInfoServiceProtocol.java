 ...
 * @Description:
 */
@Service("editorPersonalInfoServiceProtocol")
public class editorPersonalInfoServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(editorPersonalInfoServiceProtocol.class);
    private final static String interfaceDesc = "编辑我的信息";
