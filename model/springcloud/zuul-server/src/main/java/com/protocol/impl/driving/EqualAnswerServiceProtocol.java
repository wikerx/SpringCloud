 ...
 *对比答案 加入错题集
 */
@Service("equalAnswerServiceProtocol")
public class EqualAnswerServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "对比答案 加入错题集";
