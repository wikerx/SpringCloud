 ...
 * 小习惯，个人心情List
 */
@Service("MoodListServiceProtocol")
public class MoodListServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "小习惯，个人心情List";
