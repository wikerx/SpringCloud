...
@Service("intelligenceServiceProtocol")
public class IntelligenceServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(IntelligenceServiceProtocol.class);
    private final static String interfaceDesc = "比赛情报";
