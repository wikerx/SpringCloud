 ...
 * 情感心语（话题详情图片）
 */
@Service("emotionalTalkNewsImgDetailServiceProtocol")
public class emotionalTalkNewsImgDetailServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "情感心语（话题详情图片）";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            logger.info("{} 情感心语（话题详情图片）逻辑处理结果：{}",interfaceDesc,outMap.get("msg"));
        }
