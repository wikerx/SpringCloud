 ...
 *我的收藏   练习题目
 */
@Service("answerCollectServiceProtocol")
public class AnswerCollectServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "我的收藏   练习题目";
