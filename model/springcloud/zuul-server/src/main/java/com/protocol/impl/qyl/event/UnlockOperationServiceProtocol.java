...
@Service("unlockOperationServiceProtocol")
public class UnlockOperationServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(UnlockOperationServiceProtocol.class);
