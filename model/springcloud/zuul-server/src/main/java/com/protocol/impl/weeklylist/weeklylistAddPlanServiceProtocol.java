 ...
 * weeklylist添加任务
 */
@Service("weeklylistAddPlanServiceProtocol")
public class weeklylistAddPlanServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "weeklylist添加任务";
