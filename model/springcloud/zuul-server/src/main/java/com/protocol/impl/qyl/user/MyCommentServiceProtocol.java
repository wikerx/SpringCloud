 ...
 * 跟帖列表
 */
@Service("myCommentServiceProtocol")
public class MyCommentServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(MyCommentServiceProtocol.class);
    private final static String interfaceDesc = "跟帖列表";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
