 ...
 * 维修查询
 */
@Service("repairTypeInfoServiceProtocol")
public class RepairTypeInfoServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "维修全部分类";
