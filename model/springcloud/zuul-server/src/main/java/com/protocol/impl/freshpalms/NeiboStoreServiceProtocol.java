 ...
 * 首页banner
 */
@Service("neiboStoreServiceProtocol")
public class NeiboStoreServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(NeiboStoreServiceProtocol.class);
    private final static String interfaceDesc = "附近店铺";
