 ...
 * 周周清单首页
 */
@Service("weeklylistIndexServiceProtocol")
public class weeklylistIndexServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "周周清单首页";
