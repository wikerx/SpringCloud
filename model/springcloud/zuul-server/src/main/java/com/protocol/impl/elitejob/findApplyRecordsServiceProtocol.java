 ...
 * @Description:
 */
@Service("findApplyRecordsServiceProtocol")
public class findApplyRecordsServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(findApplyRecordsServiceProtocol.class);
    private final static String interfaceDesc = "申请记录";
