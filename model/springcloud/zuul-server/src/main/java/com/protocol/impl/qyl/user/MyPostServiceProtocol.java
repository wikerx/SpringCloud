 ...
 * 我的发帖列表
 */
@Service("myPostServiceProtocol")
public class MyPostServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(MyPostServiceProtocol.class);
    private final static String interfaceDesc = "我的发帖列表";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
