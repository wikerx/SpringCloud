 ...
 * 跑骑骑手端添加订单
 */
@Service("runriderInsertOrderServiceProtocol")
public class runriderInsertOrderServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "跑骑骑手端添加订单";
