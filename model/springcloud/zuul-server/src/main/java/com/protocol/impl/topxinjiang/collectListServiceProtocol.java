 ...
 * 我的收藏列表
 */
@Service("collectListServiceProtocol")
public class collectListServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "我的收藏列表";
