 ...
 *精品推荐
 */
@Service("boutiqueListServiceProtocol")
public class BoutiqueListServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "精品推荐";
