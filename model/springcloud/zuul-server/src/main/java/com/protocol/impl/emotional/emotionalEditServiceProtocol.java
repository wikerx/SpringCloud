 ...
 * 情感心语（编辑话题）,点击编辑进入的
 */
@Service("emotionalEditServiceProtocol")
public class emotionalEditServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "情感心语（编辑话题）";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            logger.info("{} 情感心语（编辑话题）逻辑处理结果：{}",interfaceDesc,outMap.get("msg"));
        }
