 ...
 * 菜谱社区列表接口
 */
@Service("recipesCommunityServiceProtocol")
public class recipesCommunityServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "菜谱社区列表接口";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
