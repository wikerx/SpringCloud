...
public class LoginServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(LoginServiceProtocol.class);
    private final static String interfaceDesc = "用户登录";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
