 ...
 * 维修查询
 */
@Service("repairSearchServiceProtocol")
public class RepairSearchServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "维修查询";
