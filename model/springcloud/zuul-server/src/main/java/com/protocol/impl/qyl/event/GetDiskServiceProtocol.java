...
@Service("getDiskServiceProtocol")
public class GetDiskServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(GetDiskServiceProtocol.class);
    private final static String interfaceDesc = "盘面";
