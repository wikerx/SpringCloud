 ...
 * weeklylist任务放弃和完成
 */
@Service("weeklylistDetaildelServiceProtocol")
public class weeklylistDetaildelServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "weeklylist任务放弃和完成";
