 ...
 *模拟考试答题
 */
@Service("simulationTestServiceProtocol")
public class SimulationTestServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "模拟考试答题";
