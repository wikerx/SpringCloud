 ...
 * weeklylist报表任务详情
 */
@Service("weeklylistDetailServiceProtocol")
public class weeklylistDetailServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "weeklylist报表任务详情";
