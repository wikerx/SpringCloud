 ...
 * 生活圈  发布多张图片
 */
@Service("lifeworldImgsServiceProtocol")
public class lifeworldImgsServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "发布图片";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            logger.info("{} 发布多张图片接口业务逻辑处理结果：{}",interfaceDesc,outMap.get("msg"));
        }
