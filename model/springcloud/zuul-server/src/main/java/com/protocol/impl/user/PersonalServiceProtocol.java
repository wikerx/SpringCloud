 ...
 * 个人中心
 */
@Service("personalServiceProtocol")
public class PersonalServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(PersonalServiceProtocol.class);
    private final static String interfaceDesc = "个人中心";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
