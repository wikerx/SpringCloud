 ...
 * 最新疆头条详情
 */
@Service("topxinjiangDetailServiceProtocol")
public class topxinjiangDetailServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "最新疆头条详情";
