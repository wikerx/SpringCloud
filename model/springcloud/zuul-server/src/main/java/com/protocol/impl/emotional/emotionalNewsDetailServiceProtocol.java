 ...
 * 首页文章详情
 */
@Service("emotionalNewsDetailServiceProtocol")
public class emotionalNewsDetailServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "首页文章详情";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            logger.info("{} 首页文章详情逻辑处理结果：{}",interfaceDesc,outMap.get("msg"));
        }
