...
@Service("supportOperationServiceProtocol")
public class SupportOperationServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SupportOperationServiceProtocol.class);
    private final static String interfaceDesc = "支持操作";
