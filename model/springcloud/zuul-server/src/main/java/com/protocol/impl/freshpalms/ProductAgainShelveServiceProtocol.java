 ...
 * 商家版 - 再次上新
 */
@Service("productAgainShelveServiceProtocol")
public class ProductAgainShelveServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(ProductAgainShelveServiceProtocol.class);
    private final static String interfaceDesc = " 商家版 - 再次上新";
