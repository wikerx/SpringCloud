 ...
 * aftersale维修反馈修改状态
 */
@Service("aftersaleUpdateStatesServiceProtocol")
public class aftersaleUpdateStatesServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "aftersale维修反馈修改状态";
