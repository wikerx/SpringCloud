 ...
 * 添加师傅技能
 */
@Service("repairAddSkillServiceProtocol")
public class RepairAddSkillServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "添加师傅技能";
