 ...
 * 商家版 - 添加产品 / 产品编辑
 */
@Service("productEditServiceProtocol")
public class ProductEditServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(ProductEditServiceProtocol.class);
    private final static String interfaceDesc = " 商家版 - 添加产品、产品编辑";
