 ...
 * 商家版 - 下架产品
 */
@Service("productOffShelveServiceProtocol")
public class ProductOffShelveServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(ProductOffShelveServiceProtocol.class);
    private final static String interfaceDesc = " 商家版 - 下架产品";
