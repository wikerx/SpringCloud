 ...
 * 我的评论
 */
@Service("myNewsCommentServiceProtocol")
public class MyNewsCommentServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(MyNewsCommentServiceProtocol.class);
    private final static String interfaceDesc = "我的评论";
