 ...
 * @Description:
 */
@Service("squareUserServiceProtocol")
public class squareUserServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(squareUserServiceProtocol.class);
    private final static String interfaceDesc = "点击用户头像查看用户详情";
