 ...
 * @Description:
 */
@Service("editorProjectExpeServiceProtocol")
public class editorProjectExpeServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(editorProjectExpeServiceProtocol.class);
    private final static String interfaceDesc = "编辑我的项目经验";
