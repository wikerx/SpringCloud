 ...
 * 卖家版 - 文章收藏、取消
 */
@Service("freshNewsCollectOrCancelServiceProtocol")
public class FreshNewsCollectOrCancelServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(FreshNewsCollectOrCancelServiceProtocol.class);
    private final static String interfaceDesc = "卖家版 - 文章收藏、取消";
