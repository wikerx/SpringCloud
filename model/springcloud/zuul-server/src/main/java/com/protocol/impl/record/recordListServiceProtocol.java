 ...
 * 记账App计一计清单页面展示
 */
@Service("recordListServiceProtocol")
public class recordListServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "记账App计一计清单页面展示";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
