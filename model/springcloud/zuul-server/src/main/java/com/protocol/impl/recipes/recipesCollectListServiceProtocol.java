 ...
 * 菜谱我的收藏列表
 */
@Service("recipesCollectListServiceProtocol")
public class recipesCollectListServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(recipesCollectListServiceProtocol.class);
    private final static String interfaceDesc = "菜谱我的收藏列表";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
