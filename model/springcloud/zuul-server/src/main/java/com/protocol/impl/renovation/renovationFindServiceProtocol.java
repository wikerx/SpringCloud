 ...
 * 装修发现页面
 */
@Service("renovationFindServiceProtocol")
public class renovationFindServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "装修发现页面";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            logger.info("{} 装修发现页面业务逻辑处理结果：{}",interfaceDesc,outMap.get("msg"));
        }
