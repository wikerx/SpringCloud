 ...
 *个人中心：观点
 */
@Service("myEventViewsServiceProtocol")
public class MyEventViewsServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(MyEventViewsServiceProtocol.class);
    private final static String interfaceDesc = "个人中心：观点";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            String accntType = String.valueOf(inputMap.get("accntType"));
            if (VerifyUtils.isEmpty(code, outMap, accntType,"accntType",logger,interfaceDesc))
                return outMap;
