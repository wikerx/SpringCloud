 ...
 * 减少购物车商品件数
 */
@Service("cartReduceServiceProtocol")
public class CartReduceServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(CartReduceServiceProtocol.class);
    private final static String interfaceDesc = "减少购物车商品件数";
