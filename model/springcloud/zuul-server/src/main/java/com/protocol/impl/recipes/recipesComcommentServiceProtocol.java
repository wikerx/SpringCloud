 ...
 * 菜谱社区模块添加评论接口
 */
@Service("recipesComcommentServiceProtocol")
public class recipesComcommentServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "菜谱社区模块添加评论接口";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
