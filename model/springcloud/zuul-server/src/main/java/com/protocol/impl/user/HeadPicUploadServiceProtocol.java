 ...
 * 上传头像
 */
@Service("headPicUploadServiceProtocol")
public class HeadPicUploadServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(HeadPicUploadServiceProtocol.class);
