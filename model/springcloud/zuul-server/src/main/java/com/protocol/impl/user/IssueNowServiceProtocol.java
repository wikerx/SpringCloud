 ...
 * 发布此刻
 */
@Service("issueNowServiceProtocol")
public class IssueNowServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(IssueNowServiceProtocol.class);
