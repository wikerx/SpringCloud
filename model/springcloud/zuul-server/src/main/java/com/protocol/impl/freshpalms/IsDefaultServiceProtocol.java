 ...
 * 获取用户默认收货地址
 */
@Service("isDefaultServiceProtocol")
public class IsDefaultServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(IsDefaultServiceProtocol.class);
    private final static String interfaceDesc = "获取用户默认收货地址";
