 ...
 * 积分录入系统首页人员下拉列表
 */
@Service("scorePeopleServiceProtocol")
public class scorePeopelServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "积分录入系统首页人员下拉列表";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            logger.info("{} 积分录入系统首页人员list接口业务逻辑处理结果：{}",interfaceDesc,outMap.get("msg"));
        }
