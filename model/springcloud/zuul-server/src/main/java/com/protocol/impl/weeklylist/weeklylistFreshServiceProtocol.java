 ...
 * 周新鲜list
 */
@Service("weeklylistFreshServiceProtocol")
public class weeklylistFreshServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "周新鲜list";
