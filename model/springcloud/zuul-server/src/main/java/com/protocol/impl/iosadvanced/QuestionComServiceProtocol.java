 ...
 * 评论
 */
@Service("questionComServiceProtocol")
public class QuestionComServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(QuestionComServiceProtocol.class);
    private final static String interfaceDesc = "评论";
