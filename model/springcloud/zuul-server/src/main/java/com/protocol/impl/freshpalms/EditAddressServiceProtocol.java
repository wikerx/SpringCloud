 ...
 * 编辑收货地址
 */
@Service("editAddressServiceProtocol")
public class EditAddressServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(EditAddressServiceProtocol.class);
    private final static String interfaceDesc = "编辑收货地址";
