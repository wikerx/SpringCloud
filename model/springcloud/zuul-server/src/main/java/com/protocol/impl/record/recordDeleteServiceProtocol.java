 ...
 * 记账App统计消费详情删除
 */
@Service("recordDeleteServiceProtocol")
public class recordDeleteServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "记账App统计消费详情删除";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
