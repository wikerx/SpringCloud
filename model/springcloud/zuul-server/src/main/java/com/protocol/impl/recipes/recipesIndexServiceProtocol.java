 ...
 * 首页结合总接口
 */
@Service("recipesIndexServiceProtocol")
public class recipesIndexServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "菜谱首页结合总接口";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
