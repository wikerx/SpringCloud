 ...
 * 增加地址接口
 */
@Service("addAddressServiceProtocol")
public class AddAddressServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(AddAddressServiceProtocol.class);
    private final static String interfaceDesc = "增加地址接口";
