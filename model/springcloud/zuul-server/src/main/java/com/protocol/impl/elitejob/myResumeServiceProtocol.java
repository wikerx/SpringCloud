 ...
 * @Description:
 */
@Service("myResumeServiceProtocol")
public class myResumeServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(myResumeServiceProtocol.class);
    private final static String interfaceDesc = "我的简历";
