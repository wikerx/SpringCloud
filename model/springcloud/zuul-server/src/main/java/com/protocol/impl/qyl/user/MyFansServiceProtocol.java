 ...
 *查询粉丝列表接口
 */
@Service("myFansServiceProtocol")
public class MyFansServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(MyFansServiceProtocol.class);
    private final static String interfaceDesc = "查询粉丝列表接口";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
