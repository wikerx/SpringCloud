 ...
 * 跑骑骑手端订单超时页面
 */
@Service("runriderTimeOutServiceProtocol")
public class runriderTimeOutServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "跑骑骑手端订单超时页面";
