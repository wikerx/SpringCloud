 ...
 * 商品收藏/取消收藏
 */
@Service("productCollectOrCancelServiceProtocol")
public class ProductCollectOrCancelServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(ProductCollectOrCancelServiceProtocol.class);
    private final static String interfaceDesc = "商品收藏/取消收藏";
