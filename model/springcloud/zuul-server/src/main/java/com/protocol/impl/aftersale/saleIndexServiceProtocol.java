 ...
 * aftersale维修服务首页
 */
@Service("saleIndexServiceProtocol")
public class saleIndexServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "aftersale维修服务首页";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            logger.info("{} aftersale维修服务首页业务逻辑处理结果：{}",interfaceDesc,outMap.get("msg"));
        }
