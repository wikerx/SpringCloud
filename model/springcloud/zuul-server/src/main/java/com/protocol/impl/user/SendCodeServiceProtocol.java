 ...
 * 发送短信验证码
 */
@Service("sendCodeServiceProtocol")
public class SendCodeServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SendCodeServiceProtocol.class);
    private final static String interfaceDesc = "发送短信验证码";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
