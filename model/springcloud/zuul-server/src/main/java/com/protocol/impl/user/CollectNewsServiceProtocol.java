 ...
 * 我的收藏 文章
 */
@Service("collectNewsServiceProtocol")
public class CollectNewsServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(CollectNewsServiceProtocol.class);
    private final static String interfaceDesc = "我的收藏 文章";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
