 ...
 * 跑骑骑手端首页
 */
@Service("runriderIndexServiceProtocol")
public class runriderIndexServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "跑骑骑手端首页";
