 ...
 * @Description:
 */
@Service("collectAndCancelForumServiceProtocol")
public class collectAndCancelForumServiceProtocol  implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(collectAndCancelForumServiceProtocol.class);
    private final static String interfaceDesc = "收藏论坛（取消收藏）";
