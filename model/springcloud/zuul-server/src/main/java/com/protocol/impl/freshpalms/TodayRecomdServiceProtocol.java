 ...
 * 今日推荐
 */
@Service("todayRecomdServiceProtocol")
public class TodayRecomdServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(TodayRecomdServiceProtocol.class);
    private final static String interfaceDesc = "今日推荐";
