 ...
 * 最新疆首页
 */
@Service("topxinjiangIndexServiceProtocol")
public class topxinjiangIndexServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "最新疆首页";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            logger.info("{} 最新疆首页接口业务逻辑处理结果：{}",interfaceDesc,outMap.get("msg"));
        }
