 ...
 *举报
 */
@Service("reportServiceProtocol")
public class ReportServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(ReportServiceProtocol.class);
    private final static String interfaceDesc = "举报";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
