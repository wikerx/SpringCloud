 ...
 * 小习惯添加习惯
 */
@Service("habitInsertServiceProtocol")
public class habitInsertServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "小习惯添加习惯";
