 ...
 *文章收藏/取消收藏
 */
@Service("drivingCollectorCancelServiceProtocol")
public class DrivingCollectorCancelServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "文章收藏/取消收藏";
