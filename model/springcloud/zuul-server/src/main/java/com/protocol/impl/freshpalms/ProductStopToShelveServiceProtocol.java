 ...
 * 商家版 - 停止上架
 */
@Service("productStopToShelveServiceProtocol")
public class ProductStopToShelveServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(ProductStopToShelveServiceProtocol.class);
    private final static String interfaceDesc = " 商家版 - 停止上架";
