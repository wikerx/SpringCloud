 ...
 * aftersale提醒事项list
 */
@Service("aftersaleRemindlistServiceProtocol")
public class aftersaleRemindlistServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "aftersale提醒事项list";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            logger.info("{} aftersale提醒事项list业务逻辑处理结果：{}",interfaceDesc,outMap.get("msg"));
        }
