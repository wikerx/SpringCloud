 ...
 * 菜谱详情页接口
 */
@Service("recipesDetailServiceProtocol")
public class recipesDetailServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "菜谱详情页接口";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
