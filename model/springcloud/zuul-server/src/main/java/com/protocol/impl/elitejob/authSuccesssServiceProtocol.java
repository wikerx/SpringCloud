 ...
 * @Description:
 */
@Service("authSuccesssServiceProtocol")
public class authSuccesssServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(authSuccesssServiceProtocol.class);
    private final static String interfaceDesc = "认证成功列表";
