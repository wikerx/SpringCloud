 ...
 * 菜谱与我相关点赞列表
 */
@Service("recipesHitServiceProtocol")
public class recipesHitServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(recipesHitServiceProtocol.class);
    private final static String interfaceDesc = "菜谱与我相关点赞列表";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
