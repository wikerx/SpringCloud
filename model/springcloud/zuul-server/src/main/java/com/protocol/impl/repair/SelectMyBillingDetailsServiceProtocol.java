 ...
 * 师傅端的我的发单详情
 */
@Service("selectMyBillingDetailsServiceProtocol")
public class SelectMyBillingDetailsServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "师傅端的我的发单详情";
