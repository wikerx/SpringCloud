 ...
 * @Description:
 */
@Service("attentionListServiceProtocol")
public class attentionListServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(attentionListServiceProtocol.class);
    private final static String interfaceDesc = "关注动态";
