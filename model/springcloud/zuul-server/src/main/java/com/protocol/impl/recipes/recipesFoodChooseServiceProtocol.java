 ...
 * 食材分类接口
 */
@Service("recipesFoodChooseServiceProtocol")
public class recipesFoodChooseServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "食材分类接口";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
