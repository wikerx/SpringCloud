 ...
 * 我的问题
 */
@Service("myQuestionServiceProtocol")
public class MyQuestionServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(MyQuestionServiceProtocol.class);
    private final static String interfaceDesc = "我的问题";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
