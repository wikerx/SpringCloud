 ...
 * 我的浏览历史list
 */
@Service("historyListServiceProtocol")
public class historyListServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "我的浏览历史list";
