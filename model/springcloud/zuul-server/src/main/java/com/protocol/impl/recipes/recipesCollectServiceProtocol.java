 ...
 * 菜谱详情用户收藏
 */
@Service("recipesCollectServiceProtocol")
public class recipesCollectServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(recipesCollectServiceProtocol.class);
    private final static String interfaceDesc = "菜谱详情用户收藏";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
...
//                return outMap;
            ...
            String detailId = String.valueOf(inputMap.get("detailId"));
            if (VerifyUtils.isEmpty(code, outMap, detailId,"detailId",logger,interfaceDesc))
                return outMap;
