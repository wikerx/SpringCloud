 ...
 * @Description:
 */
@Service("editorWorkExpeServiceProtocol")
public class editorWorkExpeServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(editorWorkExpeServiceProtocol.class);
    private final static String interfaceDesc = "编辑我的工作经历";
