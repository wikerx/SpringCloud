 ...
 *答题   问题
 */
@Service("questionAnswerServiceProtocol")
public class QuestionAnswerServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "答题   问题";
