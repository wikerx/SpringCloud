 ...
 * 生活圈（朋友圈详情点赞）
 */
@Service("lifeworldDetailHitServiceProtocol")
public class lifeworldDetailHitServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "生活圈（朋友圈详情点赞）";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
