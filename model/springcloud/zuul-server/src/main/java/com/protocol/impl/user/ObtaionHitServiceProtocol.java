 ...
 * 收到的点赞
 */
@Service("obtaionHitServiceProtocol")
public class ObtaionHitServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(ObtaionHitServiceProtocol.class);
    private final static String interfaceDesc = "收到的点赞";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
