...
/**
 * 首页必吃必游必玩列表（1：美食（必吃）  3：玩乐（必玩）   4：购物（必游））
 */
@Service("mustListServiceProtocol")
public class mustListServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "首页必吃必游必玩列表";
