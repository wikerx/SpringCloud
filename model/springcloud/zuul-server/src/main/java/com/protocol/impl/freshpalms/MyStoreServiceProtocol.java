 ...
 * 我的店铺
 */
@Service("myStoreServiceProtocol")
public class MyStoreServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(MyStoreServiceProtocol.class);
    private final static String interfaceDesc = "我的店铺";
