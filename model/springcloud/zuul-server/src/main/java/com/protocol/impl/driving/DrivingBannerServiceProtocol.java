 ...
 *首页banner
 */
@Service("drivingBannerServiceProtocol")
public class DrivingBannerServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "首页banner";
