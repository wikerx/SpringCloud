 ...
 * aftersale报表任务详情
 */
@Service("aftersaleDetailServiceProtocol")
public class aftersaleDetailServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "aftersale报表任务详情";
