 ...
 * 小习惯，心情详情
 */
@Service("MoodDetailServiceProtocol")
public class MoodDetailServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "小习惯，心情详情";
