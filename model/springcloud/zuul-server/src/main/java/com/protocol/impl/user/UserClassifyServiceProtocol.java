 ...
 * 关注人分类
 */
@Service("userClassifyServiceProtocol")
public class UserClassifyServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(UserClassifyServiceProtocol.class);
    private final static String interfaceDesc = "关注人分类";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
