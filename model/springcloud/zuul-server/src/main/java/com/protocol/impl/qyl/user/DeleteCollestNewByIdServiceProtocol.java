 ...
 *根据id删除收藏文章
 */
@Service("deleteCollestNewByIdServiceProtocol")
public class DeleteCollestNewByIdServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(DeleteCollestNewByIdServiceProtocol.class);
    private final static String interfaceDesc = "根据id删除收藏文章";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
