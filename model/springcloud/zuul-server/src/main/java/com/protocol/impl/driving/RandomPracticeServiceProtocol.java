 ...
 *随机练习
 */
@Service("randomPracticeServiceProtocol")
public class RandomPracticeServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "随机练习";
