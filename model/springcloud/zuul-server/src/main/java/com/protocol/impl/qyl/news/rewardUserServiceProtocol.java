 ...
 * @Time:14:42
 * @Description:
 */@Service("rewardUserServiceProtocol")
public class rewardUserServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(rewardUserServiceProtocol.class);
    private final static String interfaceDesc = "打赏";
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            if (VerifyUtils.isEmpty(code, outMap, newsId,"newsId",logger,interfaceDesc))
                return outMap;
            //验证score
            String score = String.valueOf(inputMap.get("score"));
            if (VerifyUtils.isEmpty(code, outMap, score,"score",logger,interfaceDesc))
                return outMap;
            //验证token
