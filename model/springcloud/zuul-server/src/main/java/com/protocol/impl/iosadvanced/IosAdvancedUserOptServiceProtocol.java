 ...
 * 登录后操作收藏，点赞，删除等
 */
@Service("iosAdvancedUserOptServiceProtocol")
public class IosAdvancedUserOptServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(IosAdvancedUserOptServiceProtocol.class);
    private final static String interfaceDesc = "登录后操作收藏，点赞，删除等";
