package com.protocol.impl.runrider;
 ...
 * 跑骑骑手端订单配送/已经送到
 */
@Service("runriderOrderUpdateStatesServiceProtocol")
public class runriderOrderUpdateStatesServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "跑骑骑手端订单配送/已经送到";
