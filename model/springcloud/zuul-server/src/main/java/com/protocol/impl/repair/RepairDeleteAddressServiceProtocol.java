 ...
 * 维修查询
 */
@Service("repairDeleteAddressServiceProtocol")
public class RepairDeleteAddressServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "删除维修地址";
