 ...
 * 装修(学装修list)
 */
@Service("renovationNewlistServiceProtocol")
public class renovationNewlistServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "装修(学装修list)";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
...
//                return outMap;
            ...
            logger.info("{} 装修(学装修list)接口业务逻辑处理结果：{}",interfaceDesc,outMap.get("msg"));
        }
