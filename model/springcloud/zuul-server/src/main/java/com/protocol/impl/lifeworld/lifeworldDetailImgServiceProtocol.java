 ...
 * 生活圈（朋友圈详情）
 */
@Service("lifeworldDetailImgServiceProtocol")
public class lifeworldDetailImgServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "生活圈（朋友圈详情）";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
