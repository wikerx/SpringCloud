 ...
 * @Description:
 */
@Service("rewardInfoServiceProtocol")
public class rewardInfoServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(rewardInfoServiceProtocol.class);
    private final static String interfaceDesc = "打赏信息";
