 ...
 * @Description:
 */
@Service("officialNewsServiceProtocol")
public class officialNewsServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(officialNewsServiceProtocol.class);
    private final static String interfaceDesc = "官方资讯";
