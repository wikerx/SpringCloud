 ...
 * 我的收藏 关注人
 */
@Service("collectUserServiceProtocol")
public class CollectUserServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(CollectUserServiceProtocol.class);
    private final static String interfaceDesc = "我的收藏 关注人";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
