 ...
 * 情感心语（话题内容详情）和详情图片不同
 */
@Service("emotionalTalkNewsDetailServiceProtocol")
public class emotionalTalkNewsDetailServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "情感心语（话题内容详情）";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            logger.info("{} 情感心语（话题内容详情）逻辑处理结果：{}",interfaceDesc,outMap.get("msg"));
        }
