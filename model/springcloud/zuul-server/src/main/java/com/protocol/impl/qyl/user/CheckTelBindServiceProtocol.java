 ...
 * 判断手机号绑定状态
 */
@Service("checkTelBindServiceProtocol")
public class CheckTelBindServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(CheckTelBindServiceProtocol.class);
    private final static String interfaceDesc = "判断手机号绑定状态";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
