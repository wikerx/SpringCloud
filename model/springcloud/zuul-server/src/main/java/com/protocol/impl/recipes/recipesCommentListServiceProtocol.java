 ...
 * 菜谱与我相关评论列表
 */
@Service("recipesCommentListServiceProtocol")
public class recipesCommentListServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(recipesCommentListServiceProtocol.class);
    private final static String interfaceDesc = "菜谱与我相关评论列表";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
