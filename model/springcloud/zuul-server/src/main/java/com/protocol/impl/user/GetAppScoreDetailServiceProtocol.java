 ...
 * 积分明细
 */
@Service("getAppScoreDetailServiceProtocol")
public class GetAppScoreDetailServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(GetAppScoreDetailServiceProtocol.class);
    private final static String interfaceDesc = "积分明细";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
