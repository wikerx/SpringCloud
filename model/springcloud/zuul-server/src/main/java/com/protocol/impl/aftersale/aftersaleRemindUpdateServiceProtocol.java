 ...
 * aftersale修改提醒事项
 */
@Service("aftersaleRemindUpdateServiceProtocol")
public class aftersaleRemindUpdateServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "aftersale修改提醒事项";
