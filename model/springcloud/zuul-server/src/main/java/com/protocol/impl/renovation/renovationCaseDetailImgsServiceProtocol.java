package com.protocol.impl.renovation;
 ...
 * 装修app（装修案例详情图集）
 */
@Service("renovationCaseDetailImgsServiceProtocol")
public class renovationCaseDetailImgsServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "装修app（装修案例详情图集）";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
    ...
    public Map service(String code, Map inputMap) {
        ...
        try {
            ...
            logger.info("{} 装修app（装修案例详情图集）接口业务逻辑处理结果：{}",interfaceDesc,outMap.get("msg"));
        }
