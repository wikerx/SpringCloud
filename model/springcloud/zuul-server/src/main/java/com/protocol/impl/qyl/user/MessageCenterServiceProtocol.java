 ...
 *消息中心
 */
@Service("messageCenterServiceProtocol")
public class MessageCenterServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(MessageCenterServiceProtocol.class);
    private final static String interfaceDesc = "消息中心";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
