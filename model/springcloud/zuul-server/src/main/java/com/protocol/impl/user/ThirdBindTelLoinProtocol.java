 ...
 * 第三方信息绑定手机号实现登录
 */
    @Service("thirdBindTelLoinProtocol")
    public class ThirdBindTelLoinProtocol implements ProtocolUtilService {
        protected final Logger logger = LoggerFactory.getLogger(ThirdBindTelLoinProtocol.class);
        private final static String interfaceDesc = "第三方信息绑定手机号实现登录";
        /**
         *
         * @param code 访问的接口编码
         * @param inputMap 请求参数
