 ...
 * 发布话题
 */
@Service("emotionalInsertNewsServiceProtocol")
public class emotionalInsertNewsServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(SignInServiceProtocol.class);
    private final static String interfaceDesc = "发布话题";
    /**
     *
     * @param code 访问的接口编码
     * @param inputMap 请求参数
