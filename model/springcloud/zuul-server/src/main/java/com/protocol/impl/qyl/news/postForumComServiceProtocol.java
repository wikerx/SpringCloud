 ...
 * @Description:
 */
@Service("postForumComServiceProtocol")
public class postForumComServiceProtocol implements ProtocolUtilService {
    protected final Logger logger = LoggerFactory.getLogger(postForumComServiceProtocol.class);
    private final static String interfaceDesc = "发表论坛评论";
