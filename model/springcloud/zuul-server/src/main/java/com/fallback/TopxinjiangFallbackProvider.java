 ...
 */
@Component
public class TopxinjiangFallbackProvider implements FallbackProvider {

	static Map<String,Object> resultMap = new HashMap<>();
	static {
		resultMap.put("code",EnumError.SERVICE_UNAVAILABLE.getCode());
		resultMap.put("msg","最新疆".concat(EnumError.SERVICE_UNAVAILABLE.getDesc()));
	}

	//表明是为哪个微服务提供回退
	@Override
	public String getRoute() {
		return "topxinjiang-server";
	}
