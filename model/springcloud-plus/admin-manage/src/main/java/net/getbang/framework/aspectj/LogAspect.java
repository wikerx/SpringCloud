package net.getbang.framework.aspectj;
...
import net.getbang.project.monitor.operlog.domain.OperLog;
import net.getbang.project.monitor.operlog.service.IOperLogService;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(net.getbang.framework.aspectj.lang.annotation.Log)")
