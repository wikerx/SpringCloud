package net.getbang.project.tool.gen.util;
...
import net.getbang.common.constant.CommonMap;
import net.getbang.common.utils.DateUtils;
...
public class GenUtils
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(getModuleName("net.getbang.project.system"));
    }
}
