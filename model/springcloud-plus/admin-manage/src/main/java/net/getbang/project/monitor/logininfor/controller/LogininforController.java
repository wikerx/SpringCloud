package net.getbang.project.monitor.logininfor.controller;
...
import net.getbang.project.monitor.logininfor.domain.Logininfor;
import net.getbang.project.monitor.logininfor.service.ILogininforService;
